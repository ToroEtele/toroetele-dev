...
export const SIDEBAR_REGULAR_TEXT =
  " text-3xs lg:text-2xs 2xl:text-1.5xs 3xl:text-xs";

export const sidebarMenuStyle = "p-0 lg:p-[0.15rem] 2xl:p-1 gap-0 2xl:gap-1";
export const sidebarGroupLabelStyle =
  "h-3 lg:h-4 group-data-[collapsible=icon]:-mt-4" + SIDEBAR_REGULAR_TEXT;
export const sidebarMenuItemTitleStyle = SIDEBAR_REGULAR_TEXT;

export const sidebarMenuButtonStyle =
  "h-3 lg:h-5 xl:h-6 p-[0.2rem] lg:p-1 gap-1 rounded-xs";
...
export const sidebarMenuItemIconContainerStyle =
  "flex aspect-square size-2.5 lg:size-4 xl:size-4.5 2xl:size-5 items-center justify-center rounded-xs 2xl:rounded-sm";
...
export const navFarmNameStyle =
  "truncate font-semibold text-3xs lg:text-2xs 3xl:text-xs";
export const navFarmYearStyle = "truncate text-4xs lg:text-3xs xl:text-2xs";
export const navFarmChevronStyle = "ml-auto size-2 xl:size-3";

export const navUserAvatarContainerStyle =
  "h-3 w-3 lg:h-4 lg:w-4 xl:h-6 xl:w-6 rounded-lg";
export const navUserAvatarStyle = "text-4xs lg:text-2xs text-gray-400";
export const navUserNameStyle = "truncate font-semibold" + SIDEBAR_REGULAR_TEXT;
export const navUserEmailStyle = "truncate text-4xs lg:text-3xs 3xl:text-2xs";
